    ...
    def get_basic_stats(self) -> dict:
        ...
        try:
            with engine.connect() as conn:
                ...
                # Table row counts
                tables = ['images', 'embeddings', 'generations', 'system_metrics', 'model_cache']
                for table in tables:
        ...
        try:
            with engine.connect() as conn:
                ...
                for row in result:
                    ...
                    trends['success_rates'].append((row.successful / row.count * 100) if row.count > 0 else 0)
    ...
    def get_model_usage_stats(self) -> dict:
        ...
        try:
            with engine.connect() as conn:
                ...
                return {
                    'embedding_models': embedding_stats,
                    'generation_models': generation_stats
                }
