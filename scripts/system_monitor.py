...
from src.utils.performance_monitor import get_performance_monitor, get_performance_summary, get_system_metrics
from src.utils.health_check import get_health_checker, run_health_check, get_health_summary
...
def main():
    ...
    parser.add_argument('command', choices=[
        'overview', 'health', 'performance', 'cache', 'monitor', 
        'export', 'optimize', 'all'
