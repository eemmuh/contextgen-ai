...
class TestAPIEndpoints:
    ...
    def test_upload_image(self, client, sample_image_file):
        ...
        with open(sample_image_file, "rb") as f:
            ...
            data = {"description": "Test image", "tags": "test,sample"}
    ...
    def test_search_images(self, client):
        ...
        with patch("src.api.app.DatabaseEmbeddingManager") as mock_embedding:
            ...
            mock_instance.search_similar.return_value = [
                {"image_id": 1, "image_path": "test.jpg", "similarity_score": 0.95}
            ]
    ...
    def test_generate_image(self, client):
        ...
        with patch("src.api.app.RAGManager") as mock_rag, patch("src.api.app.ImageGenerator") as mock_generator, patch(
            ...
            data = {"prompt": "a cat playing", "seed": 42, "num_inference_steps": 50, "guidance_scale": 7.5}
